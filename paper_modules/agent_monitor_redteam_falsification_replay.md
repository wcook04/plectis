...
This module is the public Microcosm projection of a monitor/redteam honesty
contract. It is a synthetic replay fixture, not a live monitor product, control
eval, exploit guide, or complete-security claim.
...
trajectory hash, monitor id, suspicious span ref, adversarial probe ref, verdict,
severity, escalation ref, redaction ref, mitigation ref, and cold replay ref
before the claim is admitted.

## Public Mechanics

- A monitor claim cannot pass unless the observation includes a verdict and the
  probe, escalation, mitigation, redaction, and replay refs that make the verdict
  rerunnable.
...
- Receipts expose ids, refs, verdict counts, negative cases, private-state scan,
  and authority ceilings only.
