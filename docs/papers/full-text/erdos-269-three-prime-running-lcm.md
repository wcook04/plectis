...
The statement is [Lean source](https://github.com/wcook04/plectis-erdos/blob/99f4bf47422abbd8757cbb22b50ba079d764d3a7/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L124). The same definition gives
``` math
\begin{equation}
\label{res:cube}
...
\end{equation}
```
Each term in $`F(H)`$ equals $`1/H`$, which proves the identity. The multiplicities remain present in every subsequent infinite sum. The regrouping is [Lean source](https://github.com/wcook04/plectis-erdos/blob/99f4bf47422abbd8757cbb22b50ba079d764d3a7/ErdosProblems/Erdos269/ThreePrimeRunningLcm.lean#L407).
