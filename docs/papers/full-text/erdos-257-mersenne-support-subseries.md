...
Checked as [Lean](https://github.com/wcook04/plectis-lean-erdos249-257/blob/571ec44f2aad98b44d51bdf607b70b33fd2079d0/Erdos249257/BooleanMobiusCarry.lean#L948). The finite example $`A=\{2,3\}`$ makes the definition concrete. Here $`p/q=10/21`$, and
``` math
...
| pairwise coprime, $`\sum_{a\in A}a^{-1}<\infty`$ | every $`b\ge2`$ | Erdős \[erdos1968\], theorem on p. 222; [formalised here](https://github.com/wcook04/plectis-lean-erdos249-257/blob/571ec44f2aad98b44d51bdf607b70b33fd2079d0/Erdos249257/CertificateKernel.lean#L10448) |
|  |  |  |
