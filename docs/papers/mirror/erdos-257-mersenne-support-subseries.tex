...
\end{equation}
For example, take $b=2$, $Q=6$ and $d=4$. Since $(Q,d)=2$, the
residues $6m\bmod4$ alternate between $2$ and $0$, and the weights
alternate between $4/15$ and $1/15$. Their mean is $1/6$, exactly
$2/[4(2^2-1)]$ as in \eqref{eq:gcd-orbit-mean}.
