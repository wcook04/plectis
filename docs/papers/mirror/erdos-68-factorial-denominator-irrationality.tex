...
For example, $H_2=1$ and $H_3=6/5$, so $Z_2=3$, $Z_3=8$, and
$b_3=3Z_2+1-Z_3=2$.  Thus the first test already excludes a rational
denominator dividing $2!$; the computation at $m=300000$ is the same exact
obstruction at a much stronger scale.
