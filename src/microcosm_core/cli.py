...
FIRST_SCREEN_HELP = """First-screen route:
  ...
  microcosm agent-entry-composition --task {agent-entry|getting-started|evaluation|agent-evaluation|ai-safety|finance|formal-methods|theorem-proving|interesting-parts|architecture|navigation|security|compliance|reviewer} emit Type A/human route card
