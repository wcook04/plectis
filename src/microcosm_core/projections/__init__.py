"""
Read-model projection compilers for the Plectis public substrate.

[PURPOSE]
- Teleology: Exposes `microcosm_core.projections` as a documented Microcosm public source module.
