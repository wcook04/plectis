...
def test_health_projection_counts_doctrine_routing_floor() -> None:
    ...
    assert mechanism["known_residual_selective_relation_row_count"] == 29
    assert mechanism["known_residual_selective_relation_count"] == 29
    ...
    assert paper_modules["residual_relation_count"] == 0
