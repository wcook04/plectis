...
def test_health_projection_counts_doctrine_routing_floor() -> None:
    ...
    assert mechanism["known_residual_selective_relation_row_count"] == 35
    assert mechanism["known_residual_selective_relation_count"] == 35
    ...
    assert paper_modules["selective_residual_relation_count"] == 18
    assert paper_modules["residual_relation_count"] == 18
