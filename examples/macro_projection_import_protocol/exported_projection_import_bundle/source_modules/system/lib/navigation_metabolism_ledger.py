...
def _route_lifecycle_rows() -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "status": "active_exemplar",
            "purpose": "source-derived paper-module lattice view for stable-slug doctrine exploration",
            "superseded_by": None,
            "supersedes": [
                "raw paper-module markdown as first-contact doctrine reading for supported exemplar",
                "generated paper-module sidecar authority for navigation_hologram_theory",
            ],
            "supported_slugs": ["navigation_hologram_theory"],
            ...
            "compatibility_behavior": "structured unsupported_exemplar for other slugs",
            "last_seen_in_agent_trace": None,
            "removal_condition": "do not generalize or remove until context-pack, authoring audit, entrypoint, and hook support stay green",
        },
        {
            "route_id": "skill_find",
