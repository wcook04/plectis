...
PROJECTION_REGISTRY: tuple[GeneratedProjectionOwner, ...] = (
    ...
    GeneratedProjectionOwner(
        owner_id="microcosm_public_site_projection",
        description="Static Microcosm public site packets, docs pages, deploy envelope, and client-side derived views.",
        artifacts=(
        ...
        source_authorities=(
            ...
            "microcosm-substrate/core/*.json",
            "microcosm-substrate/atlas/*.json",
        ...
        manual_edit_boundary="Do not hand-edit generated Microcosm site packets or docs pages; mutate source authorities and rerun the builder. A derived-view-only patch is valid only with the forward-integration derived projection slice contract.",
        deterministic_regeneration_expectation="repair_command must deterministically reproduce public site artifacts from declared source authorities for the current worktree.",
        stale_drift_handling="Run check_command before landing site projections; if source inputs are dirty or concurrently owned, either land the source-coupled rebuild with those inputs or land only a diff-proven derived view from a clean canonical kernel.",
    ),
    GeneratedProjectionOwner(
    ...
    GeneratedProjectionOwner(
        owner_id="microcosm_organ_atlas_projection",
        description="Microcosm public organ atlas, architecture map, agent route guide, and route JSON generated from governed organ substrate.",
        artifacts=(
            "microcosm-substrate/ORGANS.md",
            "microcosm-substrate/ARCHITECTURE.md",
        ...
        source_authorities=(
            ...
            "microcosm-substrate/src/microcosm_core/projections/concept_mechanism_read_model.py",
            "microcosm-substrate/src/microcosm_core/projections/organ_atlas.py",
            "microcosm-substrate/scripts/build_organ_atlas.py",
        ),
        check_command=(
            "./repo-python",
            "microcosm-substrate/scripts/build_organ_atlas.py",
        ...
        manual_edit_boundary="Do not hand-edit generated Microcosm public-entry atlas surfaces; mutate governed organ substrate or the organ-atlas builder, then rerun build_organ_atlas.py.",
        deterministic_regeneration_expectation="repair_command must deterministically reproduce ORGANS.md, ARCHITECTURE.md, AGENT_ROUTES.md, and atlas/agent_task_routes.json from governed organ substrate and the renderer for the current worktree.",
        stale_drift_handling="Run check_command before landing Microcosm public-entry projection changes; on drift, rerun repair_command and land source-authority changes with the regenerated atlas surfaces.",
    ),
    GeneratedProjectionOwner(
        owner_id="microcosm_doctrine_lattice_projection",
        description="Microcosm doctrine-lattice markdown, paper-module/skill JSON instances, standard-node projections, graph, coverage, health, and entry projections generated from governed doctrine JSON and lattice routing sources.",
        artifacts=(
            "microcosm-substrate/axioms/*.md",
            "microcosm-substrate/principles/*.md",
            "microcosm-substrate/anti_principles/*.md",
            "microcosm-substrate/concepts/*.md",
            "microcosm-substrate/mechanisms/*.json",
            "microcosm-substrate/mechanisms/*.md",
            "microcosm-substrate/organs/*.json",
            "microcosm-substrate/organs/*.md",
            "microcosm-substrate/paper_modules/*.json",
            "microcosm-substrate/skills/*.json",
        ...
        source_authorities=(
            ...
            "microcosm-substrate/core/organ_atlas.json",
            "microcosm-substrate/core/organ_registry.json",
            "microcosm-substrate/paper_modules/*.md",
            "microcosm-substrate/skills/*.md",
            "microcosm-substrate/axioms/*.json",
            "microcosm-substrate/principles/*.json",
            "microcosm-substrate/anti_principles/*.json",
            "microcosm-substrate/concepts/*.json",
            "microcosm-substrate/mechanisms/*.json",
            "microcosm-substrate/organs/*.json",
            "microcosm-substrate/paper_modules/*.json",
            "microcosm-substrate/skills/*.json",
            "microcosm-substrate/standards/std_microcosm_*.json",
            "microcosm-substrate/standards/std_microcosm_axiom.json",
            "microcosm-substrate/standards/std_microcosm_principle.json",
            "microcosm-substrate/standards/std_microcosm_anti_principle.json",
            "microcosm-substrate/standards/std_microcosm_concept.json",
            "microcosm-substrate/standards/std_microcosm_mechanism.json",
            "microcosm-substrate/standards/std_microcosm_organ.json",
            "microcosm-substrate/standards/std_microcosm_paper_module.json",
            "microcosm-substrate/standards/std_microcosm_skill.json",
            "microcosm-substrate/src/microcosm_core/doctrine_lattice.py",
            "microcosm-substrate/scripts/build_doctrine_projection.py",
        ),
        check_command=(
            "./repo-python",
            "microcosm-substrate/scripts/build_doctrine_projection.py",
        ...
        manual_edit_boundary="Do not hand-edit generated doctrine-lattice markdown, paper-module/skill JSON instances, graph, coverage, health, or entry surfaces; mutate governed doctrine JSON, standard JSON, routing source rows, or the lattice builder, then rerun build_doctrine_projection.py.",
        deterministic_regeneration_expectation="repair_command must deterministically reproduce doctrine-lattice projections from the governed JSON corpus, routing sources, standards, and builder for the current worktree.",
        stale_drift_handling="Run check_command before landing doctrine-lattice projections; on drift, rerun repair_command and land source-authority changes with regenerated projection surfaces.",
    ),
    GeneratedProjectionOwner(
