...
PROJECTION_REGISTRY: tuple[GeneratedProjectionOwner, ...] = (
    ...
    GeneratedProjectionOwner(
        ...
        artifacts=(
            ...
            "state/system_atlas/lean_full_fidelity_evidence_packet.json",
            "state/system_atlas/lean_full_fidelity_evidence_packet_receipt.json",
        ...
        source_authorities=(
            ...
            "tools/meta/factory/run_lean_full_fidelity_cold_reviewer_capsule.py",
        ),
        check_command=(
            "./repo-python",
            "tools/meta/factory/build_lean_mathematics_microcosm_projection.py",
        ...
        manual_edit_boundary="Do not hand-edit the Lean mathematics microcosm projection, full-fidelity packet, replay/verifier/capsule/handoff receipts, or markdown; update formal-math source surfaces, the replay/capsule runners, disclosure authority inputs, or the builder, then rerun build_lean_mathematics_microcosm_projection.py --write.",
        deterministic_regeneration_expectation="repair_command must deterministically reproduce the dynamic Lean microcosm, operator-authorized full-fidelity evidence packet, replay receipt, packet verifier receipt, cold reviewer capsule receipt, and reviewer handoff envelope from local Lean project files, diagnostics, formal-math operation receipts, generated docs, tests, and release/disclosure gate refs.",
