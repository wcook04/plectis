...
public component preserves source text, re-creates bounded behaviour,
...
author chose to require. A reader who wants to know what kind of evidence a
given component offers
can read its registry entry, which names its command, its fixture, its
receipt paths, its route, and its limit; the plain description of
