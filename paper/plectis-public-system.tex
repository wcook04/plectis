...
\par\noindent\makebox[\linewidth][c]{\fontsize{7}{8.4}\selectfont\Verb|PYTHONPATH=src python3 -m plectis comprehend --first-action "audio level calculation" --format text|}\par
