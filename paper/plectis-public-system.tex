...
outside the frame, and reaching it needs an assumption the observation does not
contain, one assumption per distinction: that the public object came from
...
assumption explicit. Once named, a gap can be disputed, assigned a cost to
...
distinctions: origin for provenance, correctness for the expected answer, meaning for
the validator's rule against the stated claim, reach for selection, and
risk for the limits of a scan. The contract's
