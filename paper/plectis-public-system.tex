...
Each route moves one class of consequential choice out of my hands. More
components or records produced while I still choose every case and rule do
not make that transfer. These five routes answer the gaps identified here;
...
it does not alter who chose the cases or rules. For the dependencies exposed
here, stronger evidence requires at least one consequential choice to leave
the author's hands.
