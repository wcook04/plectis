...
The Lean trust checker scans \leanfilecount{} Lean source files for unfinished
proof placeholders; custom axioms (assumptions added without proof); native
calculations relying on more than Lean's proof-checking kernel; \code{partial}
functions with no termination proof; \code{unsafe} definitions outside Lean's
logic; and removed computation limits. It searches source text for those forms. It cannot show
that each formal statement says what its author intended \cite{leanvalidation}.
