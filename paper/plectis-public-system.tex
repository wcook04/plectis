...
that I developed it by directing AI coding tools. The argument does not depend
...
public code to a fixed input, the code writes output, and the validator compares
that output with a stored receipt before reporting a pass or refusal. The two
