...
\paragraph{Project-wide checks.} The Lean trust checker scans
\leanfilecount{} Lean files for six source-text warning signs; it does not run
Lean or verify proofs. It flags unfinished placeholders; custom axioms
...
limits. None appeared. This does not show that the files compile, the proofs
