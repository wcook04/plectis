...
reasons and evidence. The Object Management Group's Structured Assurance Case
Metamodel (SACM) 2.3 standard models such cases as auditable claims, arguments,
and evidence; its annex maps the Claims--Arguments--Evidence notation onto SACM
...
principle have the same fingerprint. The National Institute of Standards and
Technology (NIST) estimates SHA-256's collision resistance at 128 bits; it
defines collision resistance as making such a pair computationally infeasible
to find
