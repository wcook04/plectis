...
Public reimplementation & \refactorcount & One calculation's behaviour on fixed cases. & Any relation to the private original beyond my report; the original text is absent. \\
...
At this commit, the limited \code{make test} selection (not every test file)
