# mechanism.bounded_autonomy_campaign_packet.validates_public_bounded_autonomy_campaign_packet validates public bounded autonomy campaign packet
...
The bounded-autonomy campaign packet organ validates campaign policy, failed-campaign digest handling, source-write refusal, source-module digest anchors, negative cases, body-free receipts, and authority ceilings without authorizing autonomous source mutation, campaign execution, publication, or release readiness.

## Lattice Neighbours

- `grounded_in` -> `code_locus:src/microcosm_core/organs/bounded_autonomy_campaign_packet.py` (resolved_code_locus)
- `runs_in` -> `organ:bounded_autonomy_campaign_packet` (resolved_registry_or_atlas_target)
