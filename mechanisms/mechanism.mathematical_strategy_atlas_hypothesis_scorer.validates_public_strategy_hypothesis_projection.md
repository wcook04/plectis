# mechanism.mathematical_strategy_atlas_hypothesis_scorer.validates_public_strategy_hypothesis_projection validates public strategy hypothesis projection
...
The mathematical strategy atlas hypothesis scorer validates pre-oracle strategy selection, feature-overlap routing, source-artifact consistency, copied source-module digests, unknown-strategy refusals, and body-free strategy receipts.

## Lattice Neighbours

- `grounded_in` -> `code_locus:src/microcosm_core/organs/mathematical_strategy_atlas_hypothesis_scorer.py` (resolved_code_locus)
- `runs_in` -> `organ:mathematical_strategy_atlas_hypothesis_scorer` (resolved_registry_or_atlas_target)
