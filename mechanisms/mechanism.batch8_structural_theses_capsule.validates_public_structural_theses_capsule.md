# mechanism.batch8_structural_theses_capsule.validates_public_structural_theses_capsule validates public structural theses capsule
...
The Batch 8 structural theses capsule validates a copied public structural-theses finance body by running synthetic winner, loser, and control exercises, digest and anchor checks, three negative cases, body-free receipts, and authority ceilings without live market data, investment advice, portfolio action, provider dispatch, release, or publication authority.

## Lattice Neighbours

- `grounded_in` -> `code_locus:src/microcosm_core/organs/batch8_structural_theses_capsule.py` (resolved_code_locus)
- `runs_in` -> `organ:batch8_structural_theses_capsule` (resolved_registry_or_atlas_target)
