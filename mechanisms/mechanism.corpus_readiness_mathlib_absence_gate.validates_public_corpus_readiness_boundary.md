# mechanism.corpus_readiness_mathlib_absence_gate.validates_public_corpus_readiness_boundary validates public corpus readiness boundary

_Generated from the governed mechanism JSON instance. Do not edit this markdown by hand._

- Source JSON: `mechanisms/mechanism.corpus_readiness_mathlib_absence_gate.validates_public_corpus_readiness_boundary.json`
- Registry source of record: `core/mechanism_sources.json::mechanisms[13:mechanism.corpus_readiness_mathlib_absence_gate.validates_public_corpus_readiness_boundary]`
- Authority boundary: JSON parity seed; mechanism registry source authority has not flipped.

## Statement

The corpus readiness Mathlib absence gate organ validates public formal-math corpus readiness boundaries by checking copied non-secret PROVER smoke-run corpus readiness rows, Lean/Std toolchain probe rows, Mathlib absence status, consumer-gate decisions, absent-corpus blocking, source-module manifest digests, body-free receipt policy, authority ceilings, and negative cases before writing bounded receipts.
