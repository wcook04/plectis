...
```json
{
  ...
  "trigger_summary": [
    "The Public reveal walkthrough standard declares this refine standard and propagate skill id with status planned.",
