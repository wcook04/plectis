...
```json
{
  ...
  "trigger_summary": [
    "The Proof-derived governed mutation authorization standard declares this author skill id with status planned.",
