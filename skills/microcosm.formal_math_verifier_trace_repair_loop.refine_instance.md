...
```json
{
  ...
  "trigger_summary": [
    "The Formal math verifier trace repair loop standard declares this refine instance skill id with status planned.",
