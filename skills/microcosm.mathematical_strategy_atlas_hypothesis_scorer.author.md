...
```json
{
  ...
  "trigger_summary": [
    "The Mathematical strategy atlas hypothesis scorer standard declares this author skill id with status planned.",
