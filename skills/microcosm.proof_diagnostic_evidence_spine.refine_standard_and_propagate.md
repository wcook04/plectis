...
```json
{
  ...
  "operates_standard": "std_microcosm_proof_diagnostic_evidence_spine",
  "acts_on_kind": "proof_diagnostic_evidence_spine",
  "trigger_summary": [
    "The Proof diagnostic evidence spine standard declares this refine standard and propagate skill id with status planned.",
  ...
  "workflow_summary": [
    "Read std_microcosm_proof_diagnostic_evidence_spine JSON, its authority ceiling, validator refs, receipt refs, and lattice health before editing proof_diagnostic_evidence_spine artifacts.",
