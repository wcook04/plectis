...
```json
{
  ...
  "trigger_summary": [
    "The Proof-derived governed mutation authorization standard declares this refine instance skill id with status planned.",
